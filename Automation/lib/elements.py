...
class Elements:
    ...
    dict = {
        ...
        "before_you_continue_save_dlg": ["#ctl00_cphMain_ucRegistrationModel_pnlRegistration"],
        ...
        "ghi_apply_bttn": ["[ng-click='vm.apply($index)']"],
        "ghi_max_duration": [".mc-plan-list-item-details dl dd:nth-child(8)"],
        "ghi_quote_plan_page": [".mc-planListPage"],
        "ghi_eligibility_page": ["form[name=questionsForm]"],
        "ghi_header_txt": ["div h1"],
        "ghi_question_block": ["div[class='row mc-question-block']"],
        ...
        "ghi_question_txt": [".ng-show"],
        "ghi_app_summary_box": [".mc-sidebar-summary"],
        "ghi_app_summary_hdr": [".mc-app-summary-box h3"],
        ...
        "ghi_purchase_summary_page": ["form[name=purchaseSummaryForm]"],
        "ghi_payment_billing_page": ["form[name=creditCardForm]"],
        "ghi_credit_card_fld": ["input[name=cardNumber]"],
        "ghi_cvv_fld": ["input[name=cvvCode]"],
        "ghi_firstname_billing_fld": ["input[name=firstName]"],
        "ghi_lastname_billing_fld": ["input[name=lastName]"],
        "ghi_exp_date_month_lst": ["select[name=month]"],
        "ghi_exp_date_year_lst": ["select[name=year]"],
        #"ghi_billing_address_chckbox": ["input[name=BillingAddress]"],
        "ghi_billing_address_fld": ["input[name=billingAddressLine1]"],
        "ghi_billing_city_fld": ["input[name=billingAddressCity]"],
        "ghi_billing_state_lst": ["select[name=billingAddressState]"],
